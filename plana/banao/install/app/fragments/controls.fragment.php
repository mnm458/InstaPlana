                ...
                <div class="subsection">
                    ...
                    <div class="clearfix mb-20">
                        ...
                        <div class="col s12 m6 m-last l6 l-last">
                           <input type="hidden" class="input required" name="key" value="NULLED">
                        </div>
                    </div>
                </div>
                ...
                <div class="subsection">
                    ...
                    <div class="clearfix mb-20">
                        <div class="col s12 m6 l6 mb-10">
                            ...
                            <div class="input-tip">
                                The name of the database you want to install RankPost in
                            </div>
                        </div>
                    ...
                    <!---div class="clearfix mb-20">
                        ...
                        <div class="col s12 m6 m-last l6 l-last">
                            <input type="hidden" class="input" name="db-table-prefix" value="rp_">
                        </div>
                    </div>
                </div>
