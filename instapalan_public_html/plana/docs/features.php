...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
   ...
   <nav class="navbar navbar-default navbar-light" style="box-shadow: none; border-bottom: 1px solid #f0f0f0;">
     <div class="container">
       ...
       <div class="navbar-header">
         ...
         <a class="navbar-brand" href="#"><img src="./assets/img/logo.png" alt="RankPost" /></a>
       </div>
   ...
   <li>
     ...
     <ul style="display: block">
       ...
       <li><a class="active" href="paypal.php">PayPal </a></li>
   ...
   <li><a class="" href="#" target="_blank">FAQ </a></li>
        ...
        <article class="col-md-9 col-sm-9 main-content" role="main">
          ...
          <section>
            <h2 id="installation"><a href="features.php">Features</a></h2>

            <p>Rankpost boasts the following features to help you save time and focus on more important matters:</p>

            <ol>
              <li>Modern, easy-to-use, mobile responsive UI</li>
              <li>Post Now function</li>
              <li>Schedule posts</li>
              <li>Multi Instagram Accounts.</li>
          ...
          Secure Password Hashing
              ...
              <li>Invisible packages for internal use only</li>
<li>Advanced user and package control options</li>
<li>Drag&Drop media upload</li>
<li>Recurring payment model for the Stripe</li>
            </ol>
          </section>
