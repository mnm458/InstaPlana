...
class SettingsController extends Controller
{
    ...
    public function process()
    {
        ...
        $this->setVariable("Settings", Controller::model("GeneralData", "settings"))
		     ->setVariable("Landing", Controller::model("GeneralData", "landing"))
   ...
   private function saveLanding()
    {     
       $Landing = $this->getVariable("Landing");
        $do_save= false;
        

       

        if (!is_null(Input::post("about"))) {
            $Landing->set("data.about", Input::post("about"));
            $do_save = true;
        }
        if (!is_null(Input::post("heading"))) {
            $Landing->set("data.heading", Input::post("heading"));
            $do_save = true;
        }
